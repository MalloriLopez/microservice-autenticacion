...
public class SecurityConfig {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(
        ...
        return http
                ...
                .headers(h -> h.frameOptions(fr -> fr.disable())) // H2 / Swagger en iframe
                ...
                .oauth2ResourceServer(oauth -> oauth
                        .authenticationEntryPoint((exchange, exAuth) -> {
                            ...
                            if (exAuth instanceof org.springframework.security.oauth2.server.resource.InvalidBearerTokenException) {
                                detail = "Token inválido o expirado";
                            } else if (exAuth instanceof org.springframework.security.oauth2.core.OAuth2AuthenticationException oauth2Ex) {
                                String code = oauth2Ex.getError().getErrorCode(); // p.ej. invalid_token, invalid_request
                        ...
                        .accessDeniedHandler((exchange, denied) ->
                                ...
                                writeProblem(exchange, HttpStatus.FORBIDDEN, "Forbidden", "No tienes permisos para realizar esta acción")
                        )
    ...
    public ReactiveJwtDecoder jwtDecoder(@Value("${security.jwt.secret}") String base64Secret) {
        var key = new SecretKeySpec(Base64.getDecoder().decode(base64Secret), "HmacSHA256");
    ...
    private static Collection<GrantedAuthority> extractAuthorities(Jwt jwt) {
        ...
        if (role != null && !role.isBlank()) {
            auths.add(new SimpleGrantedAuthority("ROLE_" + role)); // ej: ROLE_ADMIN
        }
